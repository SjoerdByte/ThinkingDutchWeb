    ...
    <main class="container contact-hero">
        <div class="row">
            ...
            <div class="col-12 col-lg-6 mb-2">
                ...
                <form id="wincar" method="POST" action="/backend/wincarContact.php">
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" checked value="whatsapp" id="whatsapp" name="interest[]">
...
<!--                <script>-->
<!--                    var url = "https://www.thinkingdutch.com/backend/tdmessengersite.php";-->
<!--                    var Request = {};-->
<!---->
