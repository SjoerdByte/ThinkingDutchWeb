...
<header>
    <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 box-shadow navbar-fixed">
        ...
        <nav class="mb-3 mt-3 mb-md-0 mt-md-0">
            ...
            <a class="p-2 p-md-3 nav-item <?php if($currentPage == 'products') echo 'nav-active' ?>" href="/nl/products.php">Producten</a>
            <a class="p-2 p-md-3 nav-item <?php if($currentPage == 'pricing') echo 'nav-active' ?>" href="/nl/pricing.php">Prijzen</a>
            <a class="p-2 p-md-3 nav-item <?php if($currentPage == 'contact') echo 'nav-active' ?>" href="/nl/contact.php">Contact</a>
        </nav>
